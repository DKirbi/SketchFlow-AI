# Natural language → LOFI component mapping

> **Priority reference for AI agents.** When translating a plain-language brief,
> requirement, or description into a lo-fi prototype, parse it phrase by phrase
> against this file before writing any code. Every non-technical description
> contains signal phrases that map to specific `lofi-kit` components. This
> mapping is the first step; follow it with the control-selection and composition
> rules in [`COMPOSITION_PATTERNS.md`](COMPOSITION_PATTERNS.md) and the
> interaction rules in [`UX_PATTERNS.md`](UX_PATTERNS.md).
...
*Companion files: [`LOFI_KIT_PATTERNS.md`](LOFI_KIT_PATTERNS.md) (component catalog), [`COMPOSITION_PATTERNS.md`](COMPOSITION_PATTERNS.md) (control selection + composition), [`UX_PATTERNS.md`](UX_PATTERNS.md) (interaction rules)*
